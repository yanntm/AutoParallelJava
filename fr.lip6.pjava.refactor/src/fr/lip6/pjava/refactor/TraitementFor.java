...
public class TraitementFor extends CompilationUnitRewriteOperation {
	...
	/**
	 * Permet de vider la liste des imports ajout�s
	 */
	static void clear () {
		importAdded.clear();
	}
	...
	/**
	 * Permet de v�rifier si un import n'a pas d�j� �t� ajout�
	 * @param name nom de l'import
	 * @return si l'import est pr�sent
	 */
	...
	public void rewriteAST(CompilationUnitRewrite cuRewrite, LinkedProposalModel linkedModel) throws CoreException{
		...
		//R�cup�ration du type de tableau
		ITypeBinding t = expression.resolveTypeBinding();
		
		//V�rification du type de tableau et cr�ation du machin.stream
		...
		if(tMap.getNbInstruction()==1 && tMap.getMap()!=null && tMap.getTerminale()!=null) {
			...
			if(tfb.getBody()!=null) {
				...
				//V�rification si le corps est un block, sinon on mets dans un Block
	...
	/**
	 * Permet de v�rifier le type de param�tre et si 
	 * l'appel � un mapTo est n�cessaire ou non
	 * @param parameter declaration du param�tre
	 * @param typeFor type de la collection
	 * @param ast ast appartennat au COmpilationUnit
	 * @return l'appel � un mapTo s'il y a besoin
	 */
